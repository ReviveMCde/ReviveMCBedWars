...
public class ScoreboardModule {
    ...
    public void buildLobbyScoreboard(ReviveMCPlayer reviveMCPlayer) {
        ...
        final Player player = Bukkit.getPlayer(reviveMCPlayer.getUuid());
        reviveMCScoreboardBuilder.setLine(10, "§8§m---------", "§8§m---------");
        reviveMCScoreboardBuilder.setLine(9, " ", " ");
        reviveMCScoreboardBuilder.setLine(8, " §8§l» ", "§7Ranking");
        reviveMCScoreboardBuilder.setLine(7, " §8» ", reviveMCPlayer.getSecondColor() + "#0");
        reviveMCScoreboardBuilder.setLine(6, " ", " ");
        reviveMCScoreboardBuilder.setLine(5, " §8§l» ", "§7Map");
        reviveMCScoreboardBuilder.setLine(4, " §8» ", reviveMCPlayer.getSecondColor() + "0");
        reviveMCScoreboardBuilder.setLine(3, " ", " ");
        reviveMCScoreboardBuilder.setLine(2, " §8§l» ", "§7Gold");
        reviveMCScoreboardBuilder.setLine(1, " §8» ", reviveMCPlayer.getSecondColor() + "Voting...");
        ...
        MinecraftServer.getServer().postToMainThread(() -> {
            ...
            Bukkit.getOnlinePlayers().forEach(players -> {
                ReviveMCAPI.getInstance().getCyturaTablistManager().setDefaultTablist(ReviveMCAPI.getInstance().getCyturaPlayerManager().getPlayers().get(players.getUniqueId()));
            });
        });
    }
